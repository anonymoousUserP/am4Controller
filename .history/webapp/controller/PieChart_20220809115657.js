sap.ui.define([
    ...
    createChart :  async  function(data){
        ...
        am4charts.pieSeries.slices.template.tooltipText = "";

        // Setting the manual color of pieChart
        if(data.defaultColor == false && data.defaultColor!= undefined && data.themName == undefined)
